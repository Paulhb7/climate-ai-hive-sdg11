...
interface SimpleClimateMapProps {
  city: string;
  mapboxToken: string;
  onMapLoad?: () => void;
}

export default function SimpleClimateMap({ city, mapboxToken, onMapLoad }: SimpleClimateMapProps) {
  ...
  return (
    <div style={{
      ...
      <iframe
        ...
        title="Climate Change Impact Map - Days above 32°C (90°F)"
        allow="geolocation"
      />
